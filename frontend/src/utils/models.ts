...
// Models are organized by production status with the latest Groq-available models
// Production models are recommended for stable, reliable performance
// Preview models offer newer capabilities but could be discontinued
...
// Find the default model in the Record
...
// Get a model by its ID from the Record
